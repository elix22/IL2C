...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -pipe -g2 -Wall -Werror -Wstrict-prototypes -Wno-unused -fdata-sections -ffunction-sections -pthread -D__APPLE__")
...
set(IL2C_LIBRARY_NAME_BASE "il2c-macos-${PLATFORM}-${CONFIGURATION}")
